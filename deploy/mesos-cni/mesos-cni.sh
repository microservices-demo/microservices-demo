...
do_start() {
    ...
    launch_service carts        "java -Djava.security.egd=file:/dev/urandom -jar ./app.jar --port=80 --db=carts-db.mesos-executeinstance.weave.local --logging.level.works.weave=DEBUG"      weaveworksdemos/carts       --shell
